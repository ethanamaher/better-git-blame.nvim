...
function M.investigate_selection(args)
    ...
    git_utils.get_blame_commits(selection, repo_root, function(commit_list, err)
        ...
        telescope_integration.launch_telescope_picker(commit_list, repo_root, selection)
    end)
end
...
function M.show_last_investigation()
    ...
    if current_state.last_commits then
        telescope_integration.launch_telescope_picker(current_state.last_commits, current_state.last_repo_root, current_state.last_selection)
        return
    end
end
